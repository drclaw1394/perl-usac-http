...
#
  ...
  (
    uSAC::HTTP::Middleware::Multipart::uhm_multipart(%options),     # process multipart if applicable,
    
    uSAC::HTTP::Middleware::Slurp::uhm_slurp(%options),             # Slurp the contents into memory or files
